...
resource "aws_cognito_user_pool_client" "client" {
  ...
  callback_urls = ["https://${data.aws_cloudfront_distribution.sg_www.domain_name}"]
  logout_urls = ["https://${data.aws_cloudfront_distribution.sg_www.domain_name}/_identity/logout"]
